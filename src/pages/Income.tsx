...
import { PlusCircle, Edit, Loader2, Search, FilterX, Trash2, Calendar as CalendarIcon, Hash, User, MapPin, AlertCircle } from 'lucide-react';
...
function Income() {
  ...
  const { data: incomeData, totalCount, loading } = useSupabaseData<IngresoType>({
    tableName: 'ingresos',
