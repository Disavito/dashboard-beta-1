...
const DeletionRequestsPage: React.FC = () => {
  ...
  if (userLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-card dark:bg-slate-900">
        <Loader2 className="h-12 w-12 animate-spin text-[#4892CC]" />
        <p className="mt-4 text-muted-foreground/70 font-medium">Cargando permisos...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#FAFBFC] page-enter pb-20">
      ...
      <div className="container mx-auto px-6 -mt-12 relative z-20">
        <div className="bg-card dark:bg-slate-900 rounded-2xl shadow-glass border border-border/50 p-8">
