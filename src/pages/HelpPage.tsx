              ...
              <div className="space-y-8 text-slate-600 leading-relaxed text-sm md:text-base">
                ...
                <section className="space-y-3 border-t pt-6">
                  ...
                  <ul className="list-decimal pl-5 space-y-2.5 font-medium text-slate-500">
                    ...
                    <li>
                      <span className="text-slate-800 font-bold">Localidad y Vivienda:</span> Selecciona la localidad del socio. Esto auto-completa el Distrito, Provincia y Región de su domicilio. Solo debes digitar manualmente la <strong className="font-bold text-slate-800">Dirección exacta</strong>.
                    </li>
                    <li>
                    ...
                    <li>
                      <span className="text-slate-800 font-bold">Socios de Extrema Pobreza:</span> No realizan aportaciones económicas. Sin embargo, para registrarlos en el padrón del dashboard, debes generarles un recibo con <strong className="font-bold text-slate-800">monto de S/. 0.00</strong> en el sistema.
                    </li>
                    <li>
                      <span className="text-slate-800 font-bold">Observación Administrativa:</span> Si faltan constancias de posesión o el socio está duplicado, activa la casilla <strong className="font-bold text-slate-800">Socio Observado</strong> e ingresa la justificación detallada de forma obligatoria.
                    </li>
                    <li>
                      <span className="text-slate-800 font-bold">Observación de Pagos:</span> Solo ante cobros duplicados o transferencias Yape dirigidas erróneamente a otras personas, marca <strong className="font-bold text-slate-800">Pago Observado</strong> con sus detalles correspondientes para su posterior saneamiento.
                    </li>
                  </ul>
                </section>
              ...
              <div className="space-y-8 text-slate-600 leading-relaxed text-sm md:text-base">
                <section className="space-y-3">
                  ...
                  <ul className="list-disc pl-5 space-y-2.5 font-medium text-slate-500">
                    ...
                    <li>
                      <span className="text-slate-800 font-bold">Extrema Pobreza:</span> Si el socio califica en Extrema Pobreza, no aporta fondos. Para regularizar su padrón, registra obligatoriamente el ingreso con <strong className="font-bold text-slate-800">Monto: 0.00</strong> para emitir un recibo con valor cero sin descuadrar la caja.
                    </li>
                    <li>
                    ...
                    <li>
                      <span className="text-slate-800 font-bold">Revertir Errores:</span> Si digitaste mal un cobro, ubica la fila en la tabla, haz clic en <strong className="font-bold text-slate-800">Eliminar</strong> (Tacho rojo) y detalla la justificación. Esto creará una solicitud de anulación contable pendiente de aprobación del Administrador.
                    </li>
                  </ul>
                </section>
