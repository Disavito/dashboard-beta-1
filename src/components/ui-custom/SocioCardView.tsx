  ...
  return (
    <div className="grid gap-4 w-full max-w-md mx-auto">
      {data.map((socio) => {
        ...
        return (
          <Card key={socio.id} className="w-full bg-card border-border shadow-lg transition-all duration-300 hover:shadow-premium hover:border-primary/50 overflow-hidden">
