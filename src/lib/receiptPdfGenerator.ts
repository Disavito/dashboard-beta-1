...
const generateReceiptHtml = (data: ReceiptData, clientLocality: string | null): string => {
    ...
    const title = data.isBoleta ? 'BOLETA DE VENTA' : 'RECIBO DE PAGO';
    const correlativeLabel = data.isBoleta ? 'Boleta N°' : 'Recibo N°';
            ...
            <div class="receipt-main-content">
                <div class="header-info">
                    ...
                    <div class="receipt-meta">
                        <p class="receipt-correlative-label">${correlativeLabel}</p>
